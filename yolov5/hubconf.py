...
def yolov5s(pretrained=False, channels=3, classes=1):
...
def yolov5m(pretrained=False, channels=3, classes=1):
...
def yolov5l(pretrained=False, channels=3, classes=1):
...
def yolov5x(pretrained=False, channels=3, classes=1):
